...
public class ScoreController : MonoBehaviour {
	...
	public int AddLocatorCollectedPoints(){
		int locatorPoints = Config.learningLocatorScore;

		AddToScore(locatorPoints);
		//TODO:
		//scoreLogger.LogLocatorScoreAdded(locatorPoints);

		return locatorPoints;
